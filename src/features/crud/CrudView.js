            ...
            <div className='crud-container'>
             <div>
                ...
                <form id='add-form' onSubmit={handleSubmit}>
                    <input type="text" onChange={(e)=> setName(e.target.value)} placeholder='Book Name' /><br />
                    <input type="text" onChange={(e)=> setAuthor(e.target.value)} placeholder='Author Name'/><br />
                    ...
                    <tbody>
                        {books && books.map(book =>{
                            ...
                            return <tr key={id}>
                                        ...
                                        <td>{author}</td>
                                        <td>
                                            <Link to='/edit-book' state={{id,name,author}}><button>Edit</button> </Link>
